...
# Routing
The routing app installs the hostMoved handle. Every time this function is called, the minimum path is found with the networkx library.
At this point, simple logic is used to divide between the flows that needs to be added, removed or modified between two switches. This is done in the following manner:
